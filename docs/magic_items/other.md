...
<p>
Once the box is closed, it can only be opened by solving the box’s puzzle. You can attempt to solve it by spending 8 hours working on the puzzle mechanism, after which you must succeed a DC 32 Intelligence check to open the box. You can close the box as an action, automatically scrambling the puzzle.
</p>
